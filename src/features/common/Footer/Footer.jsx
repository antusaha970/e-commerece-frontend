    ...
    <>
      ...
      <footer className="flex flex-col items-center bg-neutral-900 text-center text-white">
        <div className="container px-6 pt-6">
          ...
          <div className="mb-6">
            <p>
              At E-com, we take pride in being the best in the business. Our
              commitment to excellence is evident in every aspect of your
              shopping experience. From a vast selection of high-quality
              products across various categories to our seamless and secure
              online shopping platform, we've designed our e-commerce shop with
              you in mind. Our competitive prices, lightning-fast shipping, and
              responsive customer service team ensure that you'll receive the
              utmost satisfaction when shopping with us. Whether you're looking
              for the latest fashion trends, cutting-edge electronics, or
              essential home and garden items, E-com is your one-stop
              destination for all your needs. Join our satisfied customers and
              experience the best that online shopping has to offer, right here
              with us.
            </p>
          </div>
          {/* Links section */}
